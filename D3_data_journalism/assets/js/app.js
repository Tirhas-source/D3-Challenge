...
// creating group element to nest lower axes labels.
svg.append("g").attr("class", "xText");
// xText will allows us to select the group without excess code.
var xText = d3.select(".xText");

//  xText to transform property that places it at the bottom of the chart
...
//  append three text SVG files, with y coordinates specified 
// 1. Poverty
xText
  .append("text")
  .attr("y", -26)
